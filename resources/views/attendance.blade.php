...
<html lang="en" >
    ...
    <head>
        <meta charset="utf-8" />
        <title>
            Attendance Submission | HRD GBI Sukawarna
        </title>
                    ...
                    <div class="m-login__container">
                        ...
                        <div class="m-login__signin">
                            ...
                            ?>
                                ...
                                <form class="m-login__form m-form" action="{{ route('attend') }}" method="POST">
                                    @csrf
                                    <input type="hidden" name="actdate" value="{{ $actdate }}">
                                    <div class="form-group m-form__group">
                                        <input class="form-control m-input"   type="number" placeholder="Phone" name="phone" autocomplete="off">
                                    </div>
