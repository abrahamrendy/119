...
<div id="m_aside_left" class="m-grid__item  m-aside-left  m-aside-left--skin-dark ">
    ...
    <div 
            ...
            <ul class="m-menu__nav  m-menu__nav--dropdown-submenu-arrow ">
                ...
                <li class="m-menu__item  m-menu__item--submenu <?php if (isset($active)) { if ($active == 'gembala' || $active == 'moi') { echo 'm-menu__item--open m-menu__item--expanded'; }} ?>" aria-haspopup="true"  data-menu-submenu-toggle="hover">
                    ...
                    <div class="m-menu__submenu">
                        ...
                        <ul class="m-menu__subnav">
                            ...
                            <li class="m-menu__item <?php if (isset($active)) { if ($active == 'gembala') { echo 'm-menu__item--active'; }} ?>" aria-haspopup="true" >
                                <a  href="{{ route ('gembala') }}" class="m-menu__link ">
                            ...
                            <li class="m-menu__item <?php if (isset($active)) { if ($active == 'moi') { echo 'm-menu__item--active'; }} ?>" aria-haspopup="true" >
                                <a  href="{{ route ('moi') }}" class="m-menu__link ">
                                    <i class="m-menu__link-bullet m-menu__link-bullet--dot">
                                        <span></span>
                                    </i>
                                    <span class="m-menu__link-text">
                ...
                <li class="m-menu__section m--hide">
                    <h4 class="m-menu__section-text">
                        Snippets
                    </h4>
                    <i class="m-menu__section-icon flaticon-more-v3"></i>
                </li>
                <li class="m-menu__item  m-menu__item--submenu m--hide" aria-haspopup="true"  data-menu-submenu-toggle="hover">
                    <a  href="#" class="m-menu__link m-menu__toggle">
